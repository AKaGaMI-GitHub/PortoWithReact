...
export default function ContactSection () {
    return (
        <section id="contact" className="w-full max-w-screen-lg px-4 pt-24 pb-8 mx-auto bg-white md:pb-14 md:pt-28">
            <motion.div initial={{x: 100, opacity: 0}} whileInView={{x:0, opacity:1, transition:{ ease: [0.6,0.01,0.05,0.95], duration: 1.7 }}} viewport={{once : true}} className="flex flex-wrap justify-center mx-4 md:justify-start md:mx-0">
